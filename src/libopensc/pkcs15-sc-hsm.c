 ...
 */
static void sc_pkcs15emu_sc_hsm_format_asn1_cvcert(
 ...
 *
 */
static void sc_pkcs15emu_sc_hsm_format_asn1_req(
		struct sc_asn1_entry *asn1_authreq, size_t asn1_authreq_len,
		struct sc_asn1_entry *asn1_cvcert,
		sc_cvc_t *cvc)
{
	assert(asn1_authreq_len >= C_ASN1_AUTHREQ_SIZE);
											...
											sc_cvc_t *cvc)
{
	...
	sc_pkcs15emu_sc_hsm_format_asn1_req(
...
static void sc_asn1_sc_hsm_pka_data_init(sc_context_t *ctx,
        struct sc_asn1_sc_hsm_pka_data *data,
		sc_cvc_pka_t *pka)
{
								...
								sc_cvc_pka_t *pka)
{
	...
	sc_asn1_sc_hsm_pka_data_init(card->ctx, &format->data, pka);
